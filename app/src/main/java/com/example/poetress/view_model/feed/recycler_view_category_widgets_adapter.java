...
public class recycler_view_category_widgets_adapter extends RecyclerView.Adapter<recycler_view_category_widgets_adapter.ViewHolder> {
    ...
    public recycler_view_category_widgets_adapter(Context context, List<String> data) {
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = mInflater.inflate(R.layout.feed_recycler_category_item, parent, false);
